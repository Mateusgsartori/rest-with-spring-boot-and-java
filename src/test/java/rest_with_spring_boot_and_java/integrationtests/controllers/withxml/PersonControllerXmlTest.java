package rest_with_spring_boot_and_java.integrationtests.controllers.withxml;
...
class PersonControllerXmlTest extends AbstractIntegrationTest {
    ...
    void createPerson() throws JsonProcessingException {
        ...
        String xmlBody = objectMapper.writeValueAsString(person);

        var content = given(specification)
                .contentType(MediaType.APPLICATION_XML_VALUE)
                .accept(MediaType.APPLICATION_XML_VALUE) // <= importante
                .body(xmlBody)
                .when()
                .post()
                .then()
