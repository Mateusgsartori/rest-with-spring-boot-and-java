...
import rest_with_spring_boot_and_java.controllers.docs.AuthControllerDocs;
import rest_with_spring_boot_and_java.data.dto.security.AccountCredentialsDTO;
import rest_with_spring_boot_and_java.service.AuthService;
...
public class AuthController implements AuthControllerDocs {
    ...
    public ResponseEntity<?> signin(@RequestBody AccountCredentialsDTO credentials) {
        if (credentialsArentValid(credentials)) {
    ...
    private boolean credentialsArentValid(AccountCredentialsDTO credentials) {
